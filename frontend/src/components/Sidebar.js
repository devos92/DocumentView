...
const Sidebar = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  const menuItems = [
    ...
    { name: 'Upload document', icon: DocumentIcon, path: '/upload' },
    {
      name: 'Log Out',
  ...
  return (
    <>
      ...
      <aside
        ...
        } transition-transform duration-200 ease-in-out lg:relative lg:translate-x-0 lg:flex lg:flex-col lg:h-initial lg:shadow-lg flex-shrink-0`}
      >
