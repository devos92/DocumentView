...
const UploadDocument = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!title || !file) {
      setToast({
        type: 'error',
        message: 'Fill in all fields and select a file.',
      });
      return;
    }
    ...
    try {
      ...
      await apiClient.post(`/api/documents/${documentId}`, formData, {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full mt-1 px-8 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
